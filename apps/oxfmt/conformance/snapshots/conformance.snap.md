...
### Option 1: 21/21 (100.00%)

```json
{"printWidth":80}
```

### Option 2: 21/21 (100.00%)
...
### Option 1: 93/93 (100.00%)

```json
{"printWidth":80,"svelte":{}}
```

### Option 2: 93/93 (100.00%)
...
### Option 1: 409/409 (100.00%)

```json
{"printWidth":80}
```

### Option 2: 409/409 (100.00%)
