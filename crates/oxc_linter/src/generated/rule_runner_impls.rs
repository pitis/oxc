...
impl RuleRunner for crate::rules::vue::attribute_hyphenation::AttributeHyphenation {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::attributes_order::AttributesOrder {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::vue::first_attribute_linebreak::FirstAttributeLinebreak {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::html_end_tags::HtmlEndTags {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::html_self_closing::HtmlSelfClosing {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::vue::no_child_content::NoChildContent {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::vue::no_deprecated_filter::NoDeprecatedFilter {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner
    for crate::rules::vue::no_deprecated_functional_template::NoDeprecatedFunctionalTemplate
{
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::no_deprecated_html_element_is::NoDeprecatedHtmlElementIs {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::no_deprecated_inline_template::NoDeprecatedInlineTemplate {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner
    for crate::rules::vue::no_deprecated_router_link_tag_prop::NoDeprecatedRouterLinkTagProp
{
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::no_deprecated_scope_attribute::NoDeprecatedScopeAttribute {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::no_deprecated_slot_attribute::NoDeprecatedSlotAttribute {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner
    for crate::rules::vue::no_deprecated_slot_scope_attribute::NoDeprecatedSlotScopeAttribute
{
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::no_deprecated_v_bind_sync::NoDeprecatedVBindSync {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::no_deprecated_v_is::NoDeprecatedVIs {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner
    for crate::rules::vue::no_deprecated_v_on_native_modifier::NoDeprecatedVOnNativeModifier
{
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner
    for crate::rules::vue::no_deprecated_v_on_number_modifiers::NoDeprecatedVOnNumberModifiers
{
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::vue::no_dupe_v_else_if::NoDupeVElseIf {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::vue::no_lone_template::NoLoneTemplate {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::vue::no_parsing_error::NoParsingError {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::no_ref_as_operand::NoRefAsOperand {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}
...
impl RuleRunner for crate::rules::vue::no_textarea_mustache::NoTextareaMustache {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::vue::no_v_for_template_key_on_child::NoVForTemplateKeyOnChild {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::no_v_html::NoVHtml {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::no_v_text_v_html_on_component::NoVTextVHtmlOnComponent {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::vue::require_component_is::RequireComponentIs {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner
    for crate::rules::vue::require_toggle_inside_transition::RequireToggleInsideTransition
{
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::vue::this_in_template::ThisInTemplate {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::use_v_on_exact::UseVOnExact {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::v_bind_style::VBindStyle {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::v_on_event_hyphenation::VOnEventHyphenation {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::v_on_style::VOnStyle {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::v_slot_style::VSlotStyle {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::valid_attribute_name::ValidAttributeName {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::vue::valid_template_root::ValidTemplateRoot {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::valid_v_bind::ValidVBind {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::valid_v_cloak::ValidVCloak {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::valid_v_else::ValidVElse {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::valid_v_else_if::ValidVElseIf {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::valid_v_for::ValidVFor {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::valid_v_html::ValidVHtml {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::valid_v_if::ValidVIf {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::valid_v_is::ValidVIs {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::valid_v_memo::ValidVMemo {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::valid_v_model::ValidVModel {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::valid_v_on::ValidVOn {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::valid_v_once::ValidVOnce {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::valid_v_pre::ValidVPre {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::valid_v_show::ValidVShow {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::vue::valid_v_slot::ValidVSlot {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::svelte::button_has_type::ButtonHasType {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::svelte::comment_directive::CommentDirective {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner
    for crate::rules::svelte::experimental_require_slot_types::ExperimentalRequireSlotTypes
{
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner
    for crate::rules::svelte::experimental_require_strict_events::ExperimentalRequireStrictEvents
{
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::svelte::html_quotes::HtmlQuotes {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::svelte::html_self_closing::HtmlSelfClosing {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::svelte::mustache_spacing::MustacheSpacing {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::svelte::no_at_const_tags::NoAtConstTags {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::svelte::no_dupe_else_if_blocks::NoDupeElseIfBlocks {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::svelte::no_dupe_on_directives::NoDupeOnDirectives {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::svelte::no_dupe_style_properties::NoDupeStyleProperties {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::svelte::no_dupe_use_directives::NoDupeUseDirectives {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::svelte::no_dynamic_slot_name::NoDynamicSlotName {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::svelte::no_export_load_in_svelte_module_in_kit_pages::NoExportLoadInSvelteModuleInKitPages {
    const NODE_TYPES: Option<&AstTypesBitset> = Some(&AstTypesBitset::from_types(&[AstType::ExportDeclaration]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}
...
impl RuleRunner for crate::rules::svelte::no_inspect::NoInspect {
    const NODE_TYPES: Option<&AstTypesBitset> = Some(&AstTypesBitset::from_types(&[
        AstType::BindingIdentifier,
        AstType::IdentifierName,
        AstType::IdentifierReference,
...
impl RuleRunner for crate::rules::svelte::no_not_function_handler::NoNotFunctionHandler {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::svelte::no_object_in_text_mustaches::NoObjectInTextMustaches {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::svelte::no_raw_special_elements::NoRawSpecialElements {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::svelte::no_reactive_functions::NoReactiveFunctions {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::LabeledStatement]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::svelte::no_reactive_literals::NoReactiveLiterals {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::LabeledStatement]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::svelte::no_reactive_reassign::NoReactiveReassign {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::LabeledStatement]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}
...
impl RuleRunner for crate::rules::svelte::no_spaces_around_equal_signs_in_attribute::NoSpacesAroundEqualSignsInAttribute {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::svelte::no_store_async::NoStoreAsync {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::svelte::no_svelte_internal::NoSvelteInternal {
    const NODE_TYPES: Option<&AstTypesBitset> = Some(&AstTypesBitset::from_types(&[
        AstType::ExportAllDeclaration,
        AstType::ExportFromDeclaration,
        AstType::ImportDeclaration,
...
impl RuleRunner for crate::rules::svelte::no_target_blank::NoTargetBlank {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::svelte::no_trailing_spaces::NoTrailingSpaces {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::svelte::no_unnecessary_state_wrap::NoUnnecessaryStateWrap {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Unknown;
}
...
impl RuleRunner for crate::rules::svelte::no_unused_svelte_ignore::NoUnusedSvelteIgnore {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::svelte::no_useless_children_snippet::NoUselessChildrenSnippet {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::svelte::prefer_writable_derived::PreferWritableDerived {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::svelte::require_each_key::RequireEachKey {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner
    for crate::rules::svelte::require_event_dispatcher_types::RequireEventDispatcherTypes
{
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::svelte::require_event_prefix::RequireEventPrefix {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner
    for crate::rules::svelte::require_optimized_style_attribute::RequireOptimizedStyleAttribute
{
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::svelte::shorthand_attribute::ShorthandAttribute {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::svelte::shorthand_directive::ShorthandDirective {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::svelte::sort_attributes::SortAttributes {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}
...
impl RuleRunner for crate::rules::svelte::system::System {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::svelte::valid_each_key::ValidEachKey {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::None;
}

impl RuleRunner for crate::rules::svelte::valid_prop_names_in_kit_pages::ValidPropNamesInKitPages {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::VariableDeclarator]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}
