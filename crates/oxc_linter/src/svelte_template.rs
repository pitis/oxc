...
pub fn as_svelte_template_rule(rule: &RuleEnum) -> Option<&dyn SvelteTemplateRule> {
    match rule {
        ...
        RuleEnum::SvelteHtmlQuotes(rule) => Some(rule),
        RuleEnum::SvelteHtmlClosingBracketSpacing(rule) => Some(rule),
        RuleEnum::SvelteShorthandAttribute(rule) => Some(rule),
        RuleEnum::SvelteShorthandDirective(rule) => Some(rule),
        RuleEnum::SvelteHtmlSelfClosing(rule) => Some(rule),
        RuleEnum::SvelteMustacheSpacing(rule) => Some(rule),
        RuleEnum::SvelteNoTrailingSpaces(rule) => Some(rule),
        RuleEnum::SvelteFirstAttributeLinebreak(rule) => Some(rule),
        RuleEnum::SvelteMaxAttributesPerLine(rule) => Some(rule),
        RuleEnum::SvelteHtmlClosingBracketNewLine(rule) => Some(rule),
        ...
        RuleEnum::SvelteNoNavigationWithoutBase(rule) => Some(rule),
